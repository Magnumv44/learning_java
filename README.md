...
1. Текстовая (_наиболее удобная для мобильных устройств но не содержит навигации_)
2. HTML (_содержит навигацию по раделам, можно использовать в offline режиме на ПК или устройствах с экраном 10+ дюймов_)
...
2. [Демонстрация использования переменны](/book/chapter1/TwoProgram/Example2.java "Нажмите что-бы открыть")
...
8. [Упражнение 1.2 - ](/book/chapter1/Exercise1_2/GalToLitTable.java "Нажмите что-бы открыть")

#### Вопросы с ответами для самопроверки
[Перейти к впросам и ответам](/book/chapter1/Вопросы%20для%20самопроверки "Нажмите что-бы открыть")
